...
import { declineStaffMyAction, signStaffMyAction } from "../actions";
import type { SignatureDeskActionState } from "../actions";

/**
 * Panneau « ouvrir et signer » du membre du cabinet (Sprint 7c) :
 * document rendu en temps réel, adoption façon DocuSign, validation
 * ou refus motivé, téléchargement de la copie close.
 */
export function StaffSigningPanel({
  signerId,
  view,
  readOnly = false,
}: {
  ...
  if (state.success) {
    return (
      <div className="space-y-3" data-testid="staff-signed-final">
        ...
        <a
          ...
          data-testid="staff-download-after-sign"
        >
  ...
  return (
    <div className="space-y-4" data-testid="staff-signing-panel">
      <SigningViewer
        documentUrl={`/signatures/${signerId}/document`}
      ...
      {readOnly ? null : adoptionOpen ? (
        ...
        <p
          ...
          data-testid="staff-adopted-ok"
        >
          Votre contre-signature est adoptée et apparaît sur le document
          exactement comme elle sera apposée.
        </p>
      ) : (
        <p className="rounded-lg bg-amber-50 px-3 py-2 text-xs text-amber-800">
          Cliquez sur une zone en surbrillance du document pour adopter votre
          signature (style ou tracé).
        </p>
      )}
        ...
        <>
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              data-testid="staff-decline-toggle"
            >
              Refuser de signer…
            </button>
          </div>
          ...
          {declineOpen ? (
            <div className="space-y-2 rounded-lg border border-red-200 bg-red-50/50 p-3">
              <label className="block text-sm font-medium text-slate-700">
                Motif du refus (10 caractères minimum)
                <textarea
                  ...
                  data-testid="staff-decline-reason"
                />
              </label>
              <Button
                type="button"
                ...
                data-testid="staff-decline-submit"
                onClick={() =>
                  run(
                    declineStaffMyAction(signerId, {
